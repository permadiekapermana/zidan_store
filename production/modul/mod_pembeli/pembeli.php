...
echo "<div class='clearfix'></div>
            ...
            <div class='row'>
              <div class='col-md-12 col-sm-12 col-xs-12'>
                <div class='x_panel'>
                  <div class='x_title'>
                    <h2>Data Pembeli <small>Daftar Data Pembeli</small></h2>
            ...
            $tampil = mysql_query("SELECT * FROM `users`
                                  INNER JOIN `pembeli` ON `pembeli`.`email` = `users`.`email`
                                  WHERE aktif=1 ORDER BY id_pembeli DESC");
    ...
    while($r=mysql_fetch_array($tampil)){
        ...
        echo" <tr>
              ...
              <td>$r[hak_akses]</td>
              <td width='12%'>
                <a href='?module=pembeli&act=infopembeli&id=$r[id_pembeli]' class='btn btn-info btn-xs'><i class='fa fa-info'></i> Info</a>
              </td>
										</tr>";
						$no++;
...
<div class='col-md-12 col-sm-12 col-xs-12'>
  <div class='x_panel'>
    <div class='x_title'>
      <h2>Data Pembeli <small>Detail Data Pembeli</small></h2>
      <div class='clearfix'></div>
    </div>
    <div class='x_content'>
